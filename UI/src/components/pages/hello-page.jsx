    ...
    <div className={"whole-page"}>
      ...
      <div className="hello-hero-wrapper">
        ...
        >
          ...
          >
            <TextEffectTwo animationDuration={1} animateOnce={true} text="Design logic circuits in your browser."/>

          </h1>
          <p className="hello-hero-subtitle">
            <TextEffectTwo animationDuration={1} animateOnce={true} text="Create, simulate and sync — instantly."/>
          </p>
        </div>
      </div>
      ...
      <div className={"try-it-wrapper"}>
        ...
        <p style={{fontSize: "50px", margin: 0, fontWeight: "600"}}>
          <TextEffectTwo animationDuration={1} animateOnce={true} text="Try it now!"/>
        </p>

        <div style={{display: "flex", gap: "20px"}}>
          <button className={"try-it-button"}>Go to Library</button>
          ...
          >
            <button className={"try-it-button"}>Start Editing</button>
          </Link>
        </div>
      </div>
