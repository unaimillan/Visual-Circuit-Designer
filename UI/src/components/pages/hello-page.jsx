          ...
          <StickyBox offsetTop={window.innerHeight * 0.2}>
            <div className={"sticky-container"}>
              <div className="side-text left">
                <div
                  className={`sticky-upper-block appear-animate-left ${showBlock1 ? "visible" : ""}`}
                >
                ...
                <div
                  className={`sticky-upper-block appear-animate-left ${showBlock2 ? "visible" : ""}`}
                >
              ...
              <div className="side-text right">
                <div
                  className={`sticky-upper-block appear-animate-right ${showBlock3 ? "visible" : ""}`}
                >
                ...
                <div className={"sticky-lower-block"}>
                  <div
                    className={`sticky-upper-block appear-animate-right ${showBlock4 ? "visible" : ""}`}
                  >
