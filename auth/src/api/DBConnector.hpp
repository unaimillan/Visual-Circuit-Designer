...
namespace Poco::Data {
    ...
    class TypeHandler<class User> {
        static void bind(size_t pos, const User& obj, AbstractBinder::Ptr pBinder, AbstractBinder::Direction dir) {
        ...
        static void prepare(size_t pos, const User& obj, AbstractPreparator::Ptr pPrepare) {
        ...
        static void extract(size_t pos, User& obj, const User& defVal, AbstractExtractor::Ptr pExt) {
            int id;
            std::string username;
            std::string email;
            std::string name;
            ...
            TypeHandler<std::string>::extract(pos++, email, defVal.getEmail(), pExt);
            TypeHandler<std::string>::extract(pos++, name, defVal.getName(), pExt);
            TypeHandler<std::string>::extract(pos++, createdAt, defVal.getCreatedAt(), pExt);
            obj.setId(id);
