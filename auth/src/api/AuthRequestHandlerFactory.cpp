...
AuthRequestHandlerFactory::AuthRequestHandlerFactory(DBConnector& db): m_db(db) {}

HTTPRequestHandler* AuthRequestHandlerFactory::createRequestHandler(
    HTTPServerRequest const& request
) {
